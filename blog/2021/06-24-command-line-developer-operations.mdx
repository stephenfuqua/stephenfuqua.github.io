...
<abbr title="Integrated Development Environment">IDE</abbr> like Visual Studio
...
<div class="image">
  ![Screenshot of Visual Studio showing the build solution
  command](/img/vs2019-build-solution-menu.png)
</div>
...
<abbr title="Command Line Interface">CLI</abbr> for short) as distinguished from
"graphical user interfaces". In the screenshots above, we see the `dotnet` CLI
compared to the Visual Studio GUI.
...
<Tabs>
  <TabItem value="Interpreted" label="Interpreted Example" default>
...
```
  ...
  <TabItem value="Compiled" label="Compiled Example">
...
of [continuous integration](./05-25-infrastructure-as-code-for-build-process-automation.md)
